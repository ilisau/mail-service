...
public class BookedTourMail implements Mail {
    ...
    public Mono<Void> send(final Map<String, Object> params) {
        ...
        String emailContent = getBookedTourMail(params);
    ...
    @SneakyThrows
    private String getBookedTourMail(final Map<String, Object> params) {
